...
1. Select the number of operands of <= 100 for multiplication 
2. Give positive integer input for all the operands
3. Perform multuplication by addition
...
void performMultiplication(int &oc)
{
    ...
    while((operands1[oc] < 1) || (operands1[oc] > 100)){
